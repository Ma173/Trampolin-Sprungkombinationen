...
for element in elemente:
  print("Neues Element:",element,"mit einer Länge von",len(element))
  varianten=elemente[element]
  for variante in varianten:
    print("Variante ist:",variante)
    startposition=variante[1]
    #startposition=""
    print("Startposition ist",startposition)
...
while spruengeInUebung < 10:
  if spruengeInUebung == 0:
    ...
    if letztePosition=="Stand":
      zufallselement= ausStand[random.randrange(0,len(elemente))]
      weirdheitDesElements = zufallselement[3]
      while weirdheitDesElements>erlaubteWeirdheit:
        zufallselement= ausStand[random.randrange(0,len(elemente))]
        weirdheitDesElements = zufallselement[3]
    elif letztePosition=="Sitz":
      zufallselement= ausSitz[random.randrange(0,len(elemente))]
      weirdheitDesElements = zufallselement[3]
      while weirdheitDesElements>erlaubteWeirdheit:
        zufallselement= ausSausSitztand[random.randrange(0,len(elemente))]
        weirdheitDesElements = zufallselement[3]
    elif letztePosition=="Bauch":
      zufallselement= ausBauch[random.randrange(0,len(elemente))]
      weirdheitDesElements = zufallselement[3]
      while weirdheitDesElements>erlaubteWeirdheit:
        weirdheitDesElements = zufallselement[3]
        zufallselement= ausBauch[random.randrange(0,len(elemente))]
    elif letztePosition=="Rücken":
      zufallselement= ausRücken[random.randrange(0,len(elemente))]
      weirdheitDesElements = zufallselement[3]
      while weirdheitDesElements>erlaubteWeirdheit:
        weirdheitDesElements = zufallselement[3]
        zufallselement= ausRücken[random.randrange(0,len(elemente))]
